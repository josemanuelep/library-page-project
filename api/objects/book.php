...
class Book {
    ...
    public function readAll() {
        return  $this->conn->query( 'SELECT book.id AS book_id, book.type, book.name, book.isbn, book.borrowed, categories.category FROM `book` INNER JOIN categories ON book.type = categories.id' );
    }
